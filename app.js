...
app.get("/",function(req,res){
  res.render("home.ejs",{hcontent:homeStartingContent,array:arr});
  //console.log(arr);
});
...
app.get("/arr/:topic",function(req,res)
{
  ...
  res.render("post.ejs",{pst:y});

   }
     });
});
app.get("/about",function(req,res){
  res.render("about.ejs",{abt:aboutContent});
});
app.get("/contact",function(req,res){
  res.render("contact.ejs",{cnt:contactContent});
});
...
app.post('/send', (req, res) => {
 ...
 let transporter = nodemailer.createTransport({
  ...
  auth: {
      user: 'portfoliosthy2020@gmail.com', // generated ethereal user
...
//       to: 'dilaxn@gmail.com', // list of receivers
//       subject: 'Node Contact Request', // Subject line
//       text: 'Hello world?', // plain text body
//       html: output // html body
//   };
